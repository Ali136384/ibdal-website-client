  ...
  return (
    <div>
      <div
        ...
        className="us absolute top-0 h-full w-full -z-10"
      >
      ...
      <div className="mt-[105vh] mx-[100px]">
        <div className="flex justify-center bg-primary w-fit ml-[50%] transform translate-x-[-50%] px-3 py-1 rounded-full">
        ...
        <div className="content-us mt-20 flex justify-center gap-10 ">
          ...
          <div className="right-us w-[40%] pl-[50px]">
            <div className="flex flex-col gap-5">
              ...
              <p className="text-4xl font-bold">الأعمال التجارية هي من خلال </p>
              <p className="text-4xl font-bold">شركة زيت السيارات لدينا.</p>
            </div>
            <p className="w-[50%] mt-10 font-bold text-gray-500">
            ...
            <div className="mt-10 border-t-2 w-[50%] border-b-2 py-3">
      ...
      <div className=" mx-[100px] mt-[180px]">
        <div className="content-us mt-20 flex justify-center gap-10 min-h-[200px] ">
          ...
          <div className="right-us w-[40%] pl-[50px]">
            ...
            <div className="b-content mt-20 flex gap-12">
              <div className="w-fit pr-8 py-4 border-r-2 border-gray-200">
                <div className="bg-primary w-fit px-5 py-3  text-white font-bold">
      ...
      <div
        ...
        className="bg w-full bg-cover min-h-[450px] flex px-10 "
      >
        <div className="left p-28 relative w-[55%] ">
          <img
            className="absolute w-[200px] h-[250px] left-5 bottom-8"
            src="/pattern.png"
            alt=""
          />
        ...
        <div className="right flex relative w-full">
          <div className="relative ">
            ...
            <p className="font-bold text-5xl absolute top-[145px] left-[95px]">
              95%
            </p>
            <p className="text-center ml-8 font-bold text-3xl mt-4">
              استمرارية
            </p>
          </div>
          <div className="relative">
            ...
            <p className="text-center ml-8 font-bold text-3xl mt-4">تحسين</p>
          </div>
          <div className="relative ">
            <img src="/progressBar.png" alt="" />
            <p className="font-bold text-5xl absolute top-[145px] left-[95px]">
            ...
            <p className="text-center ml-8 font-bold text-3xl mt-4">جودة</p>
          </div>
          <img
            className="absolute w-[200px] h-[250px] -right-10 -top-5"
            src="/pattern.png"
            alt=""
          />
        </div>
